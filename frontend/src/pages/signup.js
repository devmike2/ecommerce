    ...
    return (
        <div id="signup" className="container mx-auto bg-white max-w-sm my-6 md:rounded-lg  shadow-2xl">
            ...
            <div className="block px-2 pt-6">
                <div className="relative  flex-col flex  items-center mx-auto rounded-full w-18 border-2 border-red-600 mb-8 max-h-32 ">
                    {
                        // ============================= PROFILE PIC++
                        data.profilePic ? 
                        <div className="">
                    ...
                    <div className="absolute bottom-0 bg-slate-200 py-2 opacity-80 px-4  rounded-b-full">
                        <form className=" ">
